...
Typically, when CSI drivers mount credential volumes for pods, they have to authenticate to storage providers to be trusted to access the credentials.

#### Straightforward but bad
